 ...
 */
final class Version20230606093811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meeting (id INT NOT NULL, patient_id INT DEFAULT NULL, tour_id INT DEFAULT NULL, category_id INT DEFAULT NULL, starting_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ending_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, notes TEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_patient_meeting ON meeting (patient_id, tour_id, starting_date, ending_date)');
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_provider_tour ON tour (provider_id, date)');
